...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen bg-[#f4f6fb]">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex h-screen w-64 flex-col bg-slate-900 transition-transform duration-300 lg:sticky lg:top-0 lg:translate-x-0 ${
      ...
      >
        ...
        <div className="px-4 pt-4 pb-3">
          <Link
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-violet-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm shadow-violet-600/30 transition-colors hover:bg-violet-500"
          >
...
function HomeIcon({ active }: { active: boolean }) {
  return (
    <svg className={`h-5 w-5 ${active ? "text-violet-400" : "text-slate-500"}`} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
