    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="border-t border-gray-200 p-4">
          <div className="flex items-center gap-3 rounded-lg p-2 transition-colors hover:bg-gray-100">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 text-sm font-bold text-white shadow-sm">
              JD
            </div>
            ...
            <button className="rounded-lg p-1 text-gray-400 hover:text-gray-600">
              <LogoutIcon />
            </button>
          </div>
        </div>
...
function HomeIcon({ active }: { active: boolean }) {
  return (
    <svg className={`h-5 w-5 ${active ? "text-indigo-600" : "text-gray-400"}`} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
